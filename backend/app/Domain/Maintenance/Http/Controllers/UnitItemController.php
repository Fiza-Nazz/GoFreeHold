...
class UnitItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $unitItem = $this->maintenance->createUnitItem($validated);
    ...
    {
        return response()->json(['status' => 'success', 'data' => ['unit_item' => $unitItem->load(['unit:id,number', 'item'])]]);
    }
    ...
    public function update(Request $request, UnitItem $unitItem)
    {
        ...
        $this->maintenance->updateUnitItem($unitItem, $validated);
    ...
    {
        $this->maintenance->deleteUnitItem($unitItem);
